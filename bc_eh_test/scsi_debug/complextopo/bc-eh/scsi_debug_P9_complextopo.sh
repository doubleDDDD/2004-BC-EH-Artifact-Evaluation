...
readonly CASE_ID="P9"
readonly RUN_DIR="${BC_EH_SCSI_DEBUG_ROOT}/complextopo/bc-eh/${CASE_ID}"
...
main()
{
    ...
    bc_eh_log "run ${CASE_ID}(bc-eh): fault=A,B,C on channel-0; healthy=D on channel-1"
