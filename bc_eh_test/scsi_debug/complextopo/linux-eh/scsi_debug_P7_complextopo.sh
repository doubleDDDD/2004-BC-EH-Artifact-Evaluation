...
# Fault scenario:
# - Paper case: P7, host reset returns but validation still fails
...
# - host reset succeeds
# - subsequent host-level TUR validation fails(validate_after_reset: host fail 1)
# - Recovery chain: D- -> T- -> B- -> H+ / V-
